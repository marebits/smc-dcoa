...
<dd>Emitted at DCoA creation to signal to token metadata aggregators that the metadata for this token is frozen and can <i>never be changed</i>.</dd>
</dl>
</li>
